...
# **create**
> SemanticMetricRead create(x_tenant_id, x_workspace_id, semantic_metric_create, x_correlation_id=x_correlation_id, idempotency_key=idempotency_key)
...
async with flyquery_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Create a new semantic metric in DRAFT status.
        api_response = await api_instance.create(x_tenant_id, x_workspace_id, semantic_metric_create, x_correlation_id=x_correlation_id, idempotency_key=idempotency_key)
...
# **history**
> PaginatedSemanticVersionRead history(metric_id, x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id)
...
async with flyquery_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Return version history for a metric, oldest first.
        api_response = await api_instance.history(metric_id, x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id)
        print("The response of SemanticMetricsApi->history:\n")
        pprint(api_response)
    except Exception as e:
...
# **publish**
> SemanticMetricRead publish(metric_id, x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id, idempotency_key=idempotency_key)
...
async with flyquery_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Validate, compile, and publish a metric (status → PUBLISHED).
        api_response = await api_instance.publish(metric_id, x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id, idempotency_key=idempotency_key)
...
# **retire**
> SemanticMetricRead retire(metric_id, x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id, idempotency_key=idempotency_key)
...
async with flyquery_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Retire a metric (status → RETIRED).
        api_response = await api_instance.retire(metric_id, x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id, idempotency_key=idempotency_key)
