...
# **explain**
> ExplainResponse explain(x_tenant_id, x_workspace_id, query_request, x_correlation_id=x_correlation_id, idempotency_key=idempotency_key)
...
async with flyquery_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Run Grounding + Generation but stop before AST/execution.
        api_response = await api_instance.explain(x_tenant_id, x_workspace_id, query_request, x_correlation_id=x_correlation_id, idempotency_key=idempotency_key)
...
# **query**
> AnswerResponse query(x_tenant_id, x_workspace_id, query_request, x_correlation_id=x_correlation_id, idempotency_key=idempotency_key)
...
async with flyquery_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Run the full NL → SQL → result pipeline and return a synchronous answer.
        api_response = await api_instance.query(x_tenant_id, x_workspace_id, query_request, x_correlation_id=x_correlation_id, idempotency_key=idempotency_key)
...
# **stream**
> stream(x_tenant_id, x_workspace_id, query_request, x_correlation_id=x_correlation_id, idempotency_key=idempotency_key)
...
async with flyquery_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Run the full pipeline as a Server-Sent Events stream.
        await api_instance.stream(x_tenant_id, x_workspace_id, query_request, x_correlation_id=x_correlation_id, idempotency_key=idempotency_key)
    except Exception as e:
...
# **validate**
> ValidateResponse validate(x_tenant_id, x_workspace_id, query_request, x_correlation_id=x_correlation_id, idempotency_key=idempotency_key)
...
async with flyquery_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Run Grounding + Generation + AST classification + ScopeGuard check.
        api_response = await api_instance.validate(x_tenant_id, x_workspace_id, query_request, x_correlation_id=x_correlation_id, idempotency_key=idempotency_key)
