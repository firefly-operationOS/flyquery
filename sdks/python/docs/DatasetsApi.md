...
# **list_datasets**
> PaginatedDatasetRead list_datasets(x_tenant_id, x_workspace_id, q=q, name=name, status=status, workspace_id=workspace_id, limit=limit, offset=offset, x_correlation_id=x_correlation_id)
...
async with flyquery_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Search/filter datasets for the caller's tenant.
        api_response = await api_instance.list_datasets(x_tenant_id, x_workspace_id, q=q, name=name, status=status, workspace_id=workspace_id, limit=limit, offset=offset, x_correlation_id=x_correlation_id)
...
# **purge**
> PurgeAccepted purge(dataset_id, x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id, idempotency_key=idempotency_key)
...
async with flyquery_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Hard-delete: flip status to PURGING and reclaim every blob.
        api_response = await api_instance.purge(dataset_id, x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id, idempotency_key=idempotency_key)
        print("The response of DatasetsApi->purge:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DatasetsApi->purge: %s\n" % e)
```
