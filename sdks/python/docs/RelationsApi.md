...
# **approve_relation**
> approve_relation(relation_id, x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id, idempotency_key=idempotency_key)
...
async with flyquery_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Approve a PROPOSED relation.
        await api_instance.approve_relation(relation_id, x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id, idempotency_key=idempotency_key)
...
# **list_relations**
> list_relations(dataset_id, x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id)
...
async with flyquery_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # List relations for a dataset (all statuses by default).
        await api_instance.list_relations(dataset_id, x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id)
    except Exception as e:
...
# **reject_relation**
> reject_relation(relation_id, x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id, idempotency_key=idempotency_key)
...
async with flyquery_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Reject a PROPOSED relation.
        await api_instance.reject_relation(relation_id, x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id, idempotency_key=idempotency_key)
    except Exception as e:
