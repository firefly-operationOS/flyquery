...
# **version_0**
> version_0(x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id)
...
async with flyquery_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Return service name + CalVer version tag.
        await api_instance.version_0(x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id)
    except Exception as e:
