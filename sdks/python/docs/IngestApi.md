# flyquery_sdk.IngestApi

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**cancel_job**](IngestApi.md#cancel_job) | **POST** /api/v1/ingest-jobs/{job_id}:cancel | Cooperatively cancel a job (idempotent for terminal jobs).
[**create_job**](IngestApi.md#create_job) | **POST** /api/v1/ingest-jobs | Start a background ingestion job (REPARSE/SAMPLE_REFRESH/DESCRIBE_PASS/RELATION_PASS).
[**get_job**](IngestApi.md#get_job) | **GET** /api/v1/ingest-jobs/{job_id} | Get a single ingest job.
[**list_events**](IngestApi.md#list_events) | **GET** /api/v1/ingest-jobs/{job_id}/events | Paginated event ledger for a job.
[**list_jobs**](IngestApi.md#list_jobs) | **GET** /api/v1/ingest-jobs | List ingest jobs with optional filters.
[**stream_job**](IngestApi.md#stream_job) | **GET** /api/v1/ingest-jobs/{job_id}/stream | SSE stream for real-time job progress.


# **cancel_job**
> CancelResponse cancel_job(job_id, x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id, idempotency_key=idempotency_key)
...
async with flyquery_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = flyquery_sdk.IngestApi(api_client)
    ...
    try:
        # Cooperatively cancel a job (idempotent for terminal jobs).
        api_response = await api_instance.cancel_job(job_id, x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id, idempotency_key=idempotency_key)
...
# **create_job**
> IngestJobRead create_job(x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id, idempotency_key=idempotency_key)
...
async with flyquery_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Start a background ingestion job (REPARSE/SAMPLE_REFRESH/DESCRIBE_PASS/RELATION_PASS).
        api_response = await api_instance.create_job(x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id, idempotency_key=idempotency_key)
        print("The response of IngestApi->create_job:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IngestApi->create_job: %s\n" % e)
```
...
# **get_job**
> IngestJobRead get_job(job_id, x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id)
...
async with flyquery_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a single ingest job.
        api_response = await api_instance.get_job(job_id, x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id)
...
# **list_events**
> IngestEventListResponse list_events(job_id, x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id)
...
async with flyquery_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Paginated event ledger for a job.
        api_response = await api_instance.list_events(job_id, x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id)
        print("The response of IngestApi->list_events:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IngestApi->list_events: %s\n" % e)
```
...
# **list_jobs**
> IngestJobListResponse list_jobs(x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id)
...
async with flyquery_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # List ingest jobs with optional filters.
        api_response = await api_instance.list_jobs(x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id)
...
# **stream_job**
> stream_job(job_id, x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id)
...
async with flyquery_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # SSE stream for real-time job progress.
        await api_instance.stream_job(job_id, x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id)
    except Exception as e:
        print("Exception when calling IngestApi->stream_job: %s\n" % e)
```
