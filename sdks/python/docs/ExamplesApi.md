...
[**get_example**](ExamplesApi.md#get_example) | **GET** /api/v1/examples/{example_id} | Fetch a single example by id. Returns 404 if not found.
...
# **get_example**
> ExampleRead get_example(example_id, x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id)
...
async with flyquery_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Fetch a single example by id. Returns 404 if not found.
        api_response = await api_instance.get_example(example_id, x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id)
        print("The response of ExamplesApi->get_example:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ExamplesApi->get_example: %s\n" % e)
```
...
# **list_examples**
> PaginatedExampleRead list_examples(x_tenant_id, x_workspace_id, quality=quality, dataset_id=dataset_id, limit=limit, offset=offset, x_correlation_id=x_correlation_id)
...
async with flyquery_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # List examples for the caller's workspace, with optional filters.
        api_response = await api_instance.list_examples(x_tenant_id, x_workspace_id, quality=quality, dataset_id=dataset_id, limit=limit, offset=offset, x_correlation_id=x_correlation_id)
        print("The response of ExamplesApi->list_examples:\n")
        pprint(api_response)
    except Exception as e:
