...
# **approve**
> ExampleRead approve(example_id, x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id, idempotency_key=idempotency_key)
...
async with flyquery_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Approve an example (quality → APPROVED).
        api_response = await api_instance.approve(example_id, x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id, idempotency_key=idempotency_key)
...
# **create**
> ExampleRead create(x_tenant_id, x_workspace_id, example_create, x_correlation_id=x_correlation_id, idempotency_key=idempotency_key)
...
async with flyquery_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Create an example; defaults to source=USER_CURATED, quality=PROPOSED.
        api_response = await api_instance.create(x_tenant_id, x_workspace_id, example_create, x_correlation_id=x_correlation_id, idempotency_key=idempotency_key)
...
# **list_examples**
> list_examples(x_tenant_id, x_workspace_id, quality=quality, dataset_id=dataset_id, x_correlation_id=x_correlation_id)
...
async with flyquery_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # List examples for the caller's workspace, with optional filters.
        await api_instance.list_examples(x_tenant_id, x_workspace_id, quality=quality, dataset_id=dataset_id, x_correlation_id=x_correlation_id)
    except Exception as e:
...
# **reject**
> ExampleRead reject(example_id, x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id, idempotency_key=idempotency_key)
...
async with flyquery_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Reject an example (quality → REJECTED).
        api_response = await api_instance.reject(example_id, x_tenant_id, x_workspace_id, x_correlation_id=x_correlation_id, idempotency_key=idempotency_key)
