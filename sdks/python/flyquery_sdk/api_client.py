...
from flyquery_sdk.api_response import ApiResponse, T as ApiResponseT
import flyquery_sdk.models
from flyquery_sdk import rest
from flyquery_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/26.5.10/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(flyquery_sdk.models, klass)
