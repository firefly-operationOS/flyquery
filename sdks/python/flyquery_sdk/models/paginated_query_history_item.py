...
class PaginatedQueryHistoryItem(BaseModel):
    """
    PaginatedQueryHistoryItem
    """ # noqa: E501
    has_more: Optional[StrictBool] = None
    items: Optional[List[QueryHistoryItem]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [QueryHistoryItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "limit": obj.get("limit"),
