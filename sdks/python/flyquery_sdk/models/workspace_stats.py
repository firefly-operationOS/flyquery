...
class WorkspaceStats(BaseModel):
    ...
    ingest_job_count_pending: StrictInt
    query_count_last_30d: StrictInt
    storage_used_bytes: StrictInt
    table_count: StrictInt
    token_count_last_30d: StrictInt
    __properties: ClassVar[List[str]] = ["dataset_count", "ingest_job_count_pending", "query_count_last_30d", "storage_used_bytes", "table_count", "token_count_last_30d"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ingest_job_count_pending": obj.get("ingest_job_count_pending"),
            "query_count_last_30d": obj.get("query_count_last_30d"),
            "storage_used_bytes": obj.get("storage_used_bytes"),
            "table_count": obj.get("table_count"),
            "token_count_last_30d": obj.get("token_count_last_30d")
        })
        return _obj
