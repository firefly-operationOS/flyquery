...
class PaginatedSnapshotRead(BaseModel):
    """
    PaginatedSnapshotRead
    """ # noqa: E501
    has_more: Optional[StrictBool] = None
    items: Optional[List[SnapshotRead]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [SnapshotRead.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "limit": obj.get("limit"),
