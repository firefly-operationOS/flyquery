...
class AuditEventRead(BaseModel):
    ...
    tenant_id: StrictStr
    workspace_id: UUID
    __properties: ClassVar[List[str]] = ["actor", "correlation_id", "created_at", "event_type", "id", "payload_json", "resource_id", "resource_kind", "tenant_id", "workspace_id"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if payload_json (nullable) is None
        # and model_fields_set contains the field
        if self.payload_json is None and "payload_json" in self.model_fields_set:
            _dict['payload_json'] = None
