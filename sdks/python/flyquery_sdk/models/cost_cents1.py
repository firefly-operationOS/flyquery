...
COSTCENTS1_ANY_OF_SCHEMAS = ["float", "int"]

class CostCents1(BaseModel):
    """
    CostCents1
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        instance = CostCents1.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in CostCents1 with anyOf schemas: float, int. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into CostCents1 with anyOf schemas: float, int. Details: " + ", ".join(error_messages))
        else:
            return instance
