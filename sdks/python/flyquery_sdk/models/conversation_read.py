...
class ConversationRead(BaseModel):
    ...
    turns: Optional[List[TurnRead]] = None
    updated_at: datetime
    workspace_id: UUID
    __properties: ClassVar[List[str]] = ["actor", "created_at", "id", "summary", "tenant_id", "title", "turns", "updated_at", "workspace_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "title": obj.get("title"),
            "turns": [TurnRead.from_dict(_item) for _item in obj["turns"]] if obj.get("turns") is not None else None,
