...
class PaginatedCostEventRead(BaseModel):
    """
    PaginatedCostEventRead
    """ # noqa: E501
    has_more: Optional[StrictBool] = None
    items: Optional[List[CostEventRead]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [CostEventRead.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "limit": obj.get("limit"),
