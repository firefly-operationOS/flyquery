...
class BulkFileResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["error", "file_id", "index", "original_filename", "status", "tables"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tables": [TableSummary.from_dict(_item) for _item in obj["tables"]] if obj.get("tables") is not None else None
        })
        return _obj
