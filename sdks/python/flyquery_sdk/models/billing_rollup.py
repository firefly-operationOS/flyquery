...
class BillingRollup(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["breakdown", "date_from", "date_to", "period", "total_cost_cents"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "breakdown": [BillingBreakdownItem.from_dict(_item) for _item in obj["breakdown"]] if obj.get("breakdown") is not None else None,
