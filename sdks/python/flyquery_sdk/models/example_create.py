...
class ExampleCreate(BaseModel):
    ...
    generated_sql: Annotated[str, Field(min_length=1, strict=True)]
    question: Annotated[str, Field(min_length=1, strict=True, max_length=4096)]
    __properties: ClassVar[List[str]] = ["citations_json", "dataset_id", "generated_sql", "question"]
