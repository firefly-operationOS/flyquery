...
class AgentSemanticMetricsApi:
    ...
    def _create_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/agent/semantic/metrics',
    ...
    def _get_metric_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/agent/semantic/metrics/{metric_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _history_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/agent/semantic/metrics/{metric_id}/history',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _publish_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/agent/semantic/metrics/{metric_id}:publish',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _retire_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/agent/semantic/metrics/{metric_id}:retire',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
