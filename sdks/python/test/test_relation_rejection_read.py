...
class TestRelationRejectionRead(unittest.TestCase):
    """RelationRejectionRead unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelationRejectionRead:
        """Test RelationRejectionRead
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelationRejectionRead`
        """
        model = RelationRejectionRead()
        if include_optional:
    ...
    def testRelationRejectionRead(self):
        """Test RelationRejectionRead"""
