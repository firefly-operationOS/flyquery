...
class TestCallbackDeliveryListResponse(unittest.TestCase):
    """CallbackDeliveryListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CallbackDeliveryListResponse:
        """Test CallbackDeliveryListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CallbackDeliveryListResponse`
        """
        model = CallbackDeliveryListResponse()
        if include_optional:
            return CallbackDeliveryListResponse(
                items = [
                    flyquery_sdk.models.callback_delivery_read.CallbackDeliveryRead(
                        attempts = 56, 
                        callback_url = '', 
    ...
    def testCallbackDeliveryListResponse(self):
        """Test CallbackDeliveryListResponse"""
