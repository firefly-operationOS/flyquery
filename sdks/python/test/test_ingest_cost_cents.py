...
class TestIngestCostCents(unittest.TestCase):
    """IngestCostCents unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IngestCostCents:
        """Test IngestCostCents
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IngestCostCents`
        """
        model = IngestCostCents()
        if include_optional:
