...
class TestRelationRead(unittest.TestCase):
    """RelationRead unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelationRead:
        """Test RelationRead
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelationRead`
        """
        model = RelationRead()
        if include_optional:
            return RelationRead(
