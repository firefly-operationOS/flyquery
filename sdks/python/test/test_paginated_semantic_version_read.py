...
class TestPaginatedSemanticVersionRead(unittest.TestCase):
    """PaginatedSemanticVersionRead unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedSemanticVersionRead:
        """Test PaginatedSemanticVersionRead
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedSemanticVersionRead`
        """
        model = PaginatedSemanticVersionRead()
        if include_optional:
            return PaginatedSemanticVersionRead(
                has_more = True,
                items = [
                    flyquery_sdk.models.semantic_version_read.SemanticVersionRead(
    ...
    def testPaginatedSemanticVersionRead(self):
        """Test PaginatedSemanticVersionRead"""
