...
class TestPaginatedSchemaChangeRead(unittest.TestCase):
    """PaginatedSchemaChangeRead unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedSchemaChangeRead:
        """Test PaginatedSchemaChangeRead
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedSchemaChangeRead`
        """
        model = PaginatedSchemaChangeRead()
        if include_optional:
            return PaginatedSchemaChangeRead(
                has_more = True,
                items = [
                    flyquery_sdk.models.schema_change_read.SchemaChangeRead(
                        after_json = { }, 
    ...
    def testPaginatedSchemaChangeRead(self):
        """Test PaginatedSchemaChangeRead"""
