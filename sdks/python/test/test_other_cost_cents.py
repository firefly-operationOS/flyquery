...
class TestOtherCostCents(unittest.TestCase):
    """OtherCostCents unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OtherCostCents:
        """Test OtherCostCents
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OtherCostCents`
        """
        model = OtherCostCents()
        if include_optional:
