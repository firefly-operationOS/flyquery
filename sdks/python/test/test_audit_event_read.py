...
class TestAuditEventRead(unittest.TestCase):
    """AuditEventRead unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuditEventRead:
        """Test AuditEventRead
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuditEventRead`
        """
