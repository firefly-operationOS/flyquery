...
class TestPaginatedQueryHistoryItem(unittest.TestCase):
    """PaginatedQueryHistoryItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedQueryHistoryItem:
        """Test PaginatedQueryHistoryItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedQueryHistoryItem`
        """
        model = PaginatedQueryHistoryItem()
        if include_optional:
            return PaginatedQueryHistoryItem(
                has_more = True,
                items = [
                    flyquery_sdk.models.query_history_item.QueryHistoryItem(
                        ast_classification = '', 
    ...
    def testPaginatedQueryHistoryItem(self):
        """Test PaginatedQueryHistoryItem"""
