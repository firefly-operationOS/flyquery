...
class TestCostCents1(unittest.TestCase):
    """CostCents1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CostCents1:
        """Test CostCents1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CostCents1`
        """
        model = CostCents1()
        if include_optional:
            return CostCents1(
