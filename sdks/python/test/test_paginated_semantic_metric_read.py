...
class TestPaginatedSemanticMetricRead(unittest.TestCase):
    """PaginatedSemanticMetricRead unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedSemanticMetricRead:
        """Test PaginatedSemanticMetricRead
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedSemanticMetricRead`
        """
        model = PaginatedSemanticMetricRead()
        if include_optional:
            return PaginatedSemanticMetricRead(
                has_more = True,
                items = [
                    flyquery_sdk.models.semantic_metric_read.SemanticMetricRead(
    ...
    def testPaginatedSemanticMetricRead(self):
        """Test PaginatedSemanticMetricRead"""
