...
class TestWorkspaceStats(unittest.TestCase):
    """WorkspaceStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkspaceStats:
        """Test WorkspaceStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkspaceStats`
        """
        model = WorkspaceStats()
        if include_optional:
            return WorkspaceStats(
                dataset_count = 56,
                ingest_job_count_pending = 56,
                query_count_last_30d = 56,
                storage_used_bytes = 56,
                table_count = 56,
                token_count_last_30d = 56
            )
        else:
            return WorkspaceStats(
                dataset_count = 56,
