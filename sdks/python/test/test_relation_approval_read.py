...
class TestRelationApprovalRead(unittest.TestCase):
    """RelationApprovalRead unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelationApprovalRead:
        """Test RelationApprovalRead
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelationApprovalRead`
        """
        model = RelationApprovalRead()
        if include_optional:
    ...
    def testRelationApprovalRead(self):
        """Test RelationApprovalRead"""
