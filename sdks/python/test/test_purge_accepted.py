...
class TestPurgeAccepted(unittest.TestCase):
    """PurgeAccepted unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PurgeAccepted:
        """Test PurgeAccepted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PurgeAccepted`
        """
        model = PurgeAccepted()
        if include_optional:
