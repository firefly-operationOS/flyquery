...
class TestPaginatedAuditEventRead(unittest.TestCase):
    """PaginatedAuditEventRead unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedAuditEventRead:
        """Test PaginatedAuditEventRead
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedAuditEventRead`
        """
        model = PaginatedAuditEventRead()
        if include_optional:
            return PaginatedAuditEventRead(
                has_more = True,
                items = [
                    flyquery_sdk.models.audit_event_read.AuditEventRead(
                        actor = '', 
                        correlation_id = '', 
    ...
    def testPaginatedAuditEventRead(self):
        """Test PaginatedAuditEventRead"""
