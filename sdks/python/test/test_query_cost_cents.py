...
class TestQueryCostCents(unittest.TestCase):
    """QueryCostCents unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryCostCents:
        """Test QueryCostCents
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryCostCents`
        """
        model = QueryCostCents()
        if include_optional:
