 ...
 */
@JsonPropertyOrder({
  ConversationCreate.JSON_PROPERTY_TITLE
})
...
public class ConversationCreate {
  ...
  public ConversationCreate title(@jakarta.annotation.Nullable String title) {
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.title, conversationCreate.title);
  }
