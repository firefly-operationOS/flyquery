...
public class ConversationTurnRequest {
  ...
  public ConversationTurnRequest datasetId(@jakarta.annotation.Nonnull UUID datasetId) {
  ...
  public ConversationTurnRequest question(@jakarta.annotation.Nonnull String question) {
