...
public class FilesApi {
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec uploadFilesBulkRequestCreation(@javax.annotation.Nonnull String datasetId) throws WebClientResponseException {
        Object postBody = null;
        // verify the required parameter 'datasetId' is set
        if (datasetId == null) {
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<BulkFileUploadResponse> uploadFilesBulk(@javax.annotation.Nonnull String datasetId) throws WebClientResponseException {
        ParameterizedTypeReference<BulkFileUploadResponse> localVarReturnType = new ParameterizedTypeReference<BulkFileUploadResponse>() {};
        return uploadFilesBulkRequestCreation(datasetId).bodyToMono(localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<BulkFileUploadResponse>> uploadFilesBulkWithHttpInfo(@javax.annotation.Nonnull String datasetId) throws WebClientResponseException {
        ParameterizedTypeReference<BulkFileUploadResponse> localVarReturnType = new ParameterizedTypeReference<BulkFileUploadResponse>() {};
        return uploadFilesBulkRequestCreation(datasetId).toEntity(localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec uploadFilesBulkWithResponseSpec(@javax.annotation.Nonnull String datasetId) throws WebClientResponseException {
        return uploadFilesBulkRequestCreation(datasetId);
    }
}
