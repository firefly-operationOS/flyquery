...
public class FileUploadResponse {
  ...
  public FileUploadResponse fileId(@jakarta.annotation.Nonnull String fileId) {
  ...
  public FileUploadResponse tables(@jakarta.annotation.Nonnull List<TableSummary> tables) {
  ...
  @JsonProperty(value = JSON_PROPERTY_TABLES, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setTables(@jakarta.annotation.Nonnull List<TableSummary> tables) {
    this.tables = tables;
  }
