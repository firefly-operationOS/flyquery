...
import io.firefly.flyquery.auth.Authentication;
import io.firefly.flyquery.auth.HttpBasicAuth;
import io.firefly.flyquery.auth.HttpBearerAuth;
import io.firefly.flyquery.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    protected void init() {
        ...
        setUserAgent("OpenAPI-Generator/26.5.2/java");
     ...
     * @return a {@link io.firefly.flyquery.ApiClient} object
     */
    ...
    */
     ...
     * @throws io.firefly.flyquery.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws io.firefly.flyquery.ApiException If fail to serialize the given object
     */
     ...
     * @throws io.firefly.flyquery.ApiException If fail to read file content from response and write to disk
     ...
     * @throws io.firefly.flyquery.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws io.firefly.flyquery.ApiException If the response has an unsuccessful status code or
     ...
     * @throws io.firefly.flyquery.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws io.firefly.flyquery.ApiException If fails to update the parameters
     */
     ...
     * @throws io.firefly.flyquery.ApiException If fail to serialize the request body object into a string
     */
