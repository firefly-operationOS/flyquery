...
/**
 * API tests for SqlExecuteApi
 */
@Disabled
public class SqlExecuteApiTest {

    private final SqlExecuteApi api = new SqlExecuteApi();
    ...
    public void executeTest()  {
        ...
        //SqlExecuteResponse response = api.execute(xTenantId, xWorkspaceId, sqlExecuteRequest, xCorrelationId, idempotencyKey).block();
    ...
    public void executeStreamTest()  {
        ...
        //UUID xCorrelationId = null;
        //String idempotencyKey = null;
        //String response = api.executeStream(xTenantId, xWorkspaceId, sqlExecuteRequest, xCorrelationId, idempotencyKey).block();
