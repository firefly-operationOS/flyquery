...
> SchemaChangeRead confirm(changeId, xTenantId, xWorkspaceId, xCorrelationId, idempotencyKey)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            SchemaChangeRead result = apiInstance.confirm(changeId, xTenantId, xWorkspaceId, xCorrelationId, idempotencyKey);
